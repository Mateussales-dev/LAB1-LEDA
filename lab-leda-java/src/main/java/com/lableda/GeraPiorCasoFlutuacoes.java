...
public class GeraPiorCasoFlutuacoes {

    public void gerarPiorCaso() {
        String diretorioAtual = System.getProperty("user.dir");
        String caminhoEntrada = diretorioAtual + System.getProperty("file.separator") + "melhorCasoFlutuacoes.csv";
        String novoCaminhoSaida = diretorioAtual + System.getProperty("file.separator") + "piorCasoFlutuacoes.csv";
