...
public class GeraPiorCasoVolumes {

    public void gerarPiorCaso() {
        String diretorioAtual = System.getProperty("user.dir");
        String caminhoEntrada = diretorioAtual + System.getProperty("file.separator") + "melhorCasoVolume.csv";
        String novoCaminhoSaida = diretorioAtual + System.getProperty("file.separator") + "piorCasoVolume.csv";
